#adapted from https://github.com/Human9000/nd-Mamba2-torch/blob/main/torchnssd/ex_vssd.py
...
def test_export_onnx(net, x):
    torch.onnx.export(net,
                      x,
                      f"{net.__class__.__name__}.onnx",  # 输出的 ONNX 文件名
...
if __name__ == '__main__':
    ...
    backbone.eval()
    net = backbone.layers[0]
    #print(net)
    #print(backbone)
    #dim, input_resolution, num_heads,
    #bakcbone = VMAMBA2Block(32*16,input_resolution=(32, 32), num_heads=64,  linear_attn_duality=False, ssd_chunk_size=32).cuda()
