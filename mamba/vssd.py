#adapted from https://github.com/Human9000/nd-Mamba2-torch/blob/main/torchnssd/vssd_torch.py
import torch
...
if __name__ == '__main__':
    ...
    bakcbone = Backbone_VMAMBA2(linear_attn_duality=True, ssd_chunk_size=32).to(device)
    x = torch.randn(1, 3, 32 * 64, 32 * 16).to(device)
    ys = bakcbone(x)
